...
const translations = {
    es: {
        ...
        hero_title: "CUIDA TU PIEL A TIEMPO, CON CONFIANZA Y PRECISIÓN",
        hero_desc: "DermaScan te ayuda a monitorear tu piel de forma simple y confiable, manteniendo un registro de tus resultados y conectándote con especialistas cuando lo necesites.",
        btn_early_access: "Unirme",
        how_title: "¿CÓMO FUNCIONA?",
        step1_title: "Escanea",
        step1_desc: "Toma una foto de tu piel con nuestra cámara inteligente.",
        step2_title: "Analiza",
        step2_desc: "Nuestra IA procesa la imagen en segundos.",
        step3_title: "Recibe",
        step3_desc: "Obtén un pre-diagnóstico y recomendaciones.",
        benefits_title: "BENEFICIOS DE DERMASCAN",
        benefit1_title: "Detección temprana",
        benefit1_desc: "Identifica posibles anomalías en tu piel en etapas iniciales, permitiendo un tratamiento oportuno.",
        benefit2_title: "Resultados Rápidos",
        benefit2_desc: "Obtén resultados en minutos, sin necesidad de citas médicas ni largas esperas.",
        benefit3_title: "Privacidad Garantizada",
        benefit3_desc: "Tus datos e imágenes se mantienen confidenciales y protegidos en todo momento.",
        ...
        feature1_title: "Análisis de lunares",
        ...
        feature2_desc: "Monitorea la evolución de manchas en tu piel a lo largo del tiempo.",
        feature3_title: "Control de acné",
        ...
        test1_text: "“DermaScan me ayudó a detectar un lunar sospechoso que resultó ser un melanoma en etapa temprana. Gracias a la app, pude recibir tratamiento a tiempo y salvar mi vida.”",
        test2_name: "Carlos Lopez",
        test2_time: "hace 1 mes",
        test2_text: "\"La app es muy fácil de usar y los resultados son rápidos. Me ha ayudado a controlar mi acné y mejorar mi piel.\"",
        ...
        doc_quote: "\"Una herramienta excelente para el triaje dermatológico.\"",
        doc_cite: "- Dr. Juan Pérez, Dermatólogo Certificado",

        faq_title: "Preguntas Frecuentes",
        faq_q1: "¿Es gratuito?",
        faq_a1: "Sí, la versión básica es gratuita.",
        faq_q2: "¿Sustituye al médico?",
        faq_a2: "No, es una herramienta de apoyo y monitoreo.",
        faq_q3: "¿Mis datos están seguros?",
        faq_a3: "Sí, usamos encriptación de grado médico.",
    ...
    en: {
        ...
        test1_text: "“DermaScan helped me detect a suspicious mole that turned out to be early-stage melanoma. Thanks to the app, I was able to get treatment on time and save my life.”",
        test2_name: "Carlos Lopez",
        ...
        doc_cite: "- Dr. Juan Pérez, Certified Dermatologist",
